...
const Contador = () => {
  ...
  return (
      ...
      <button onClick={agregarCarrito} className='border-1 border-black border-solid rounded-md text-3xl btn btn-s hover:bg-green-500 bg-green-300 text-black'>Comprar</button>
      </div>
  )
}
